...
const DARK: Palette = {
  isDark: true,
  bg: '#0A0A1A',
  bgGradient: ['#0A0A1A', '#2B1602', '#1F0A0A'] as const,
  card: 'rgba(26, 22, 50, 0.85)',
  cardGradient: ['#1E1B3A', '#2A1F4D'] as const,
  text: '#F3F4F6',
  textSecondary: '#9CA3AF',
  accent: '#D97706',
  accentGradient: ['#D97706', '#DC2626'] as const,
  danger: '#EF4444',
  success: '#10B981',
  gold: '#F59E0B',
  border: 'rgba(255,255,255,0.08)',
  headerGradient: ['#2B1602', '#78350F', '#7F1D1D'] as const,
};
...
const K_THEME = '@poker/theme-mode';
const K_LOCALE = '@poker/locale';
