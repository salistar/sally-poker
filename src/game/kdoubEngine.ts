/**
 * PokerEngine - Moteur de jeu Poker marocain
 ...
 *   est rompue par un "Poker!" (contestation) ou quand tout le monde passe
 *   sans contester (alors le joueur suivant peut recommencer avec une nouvelle
 *   valeur — cela clôt la séquence précédente).
 * - N'importe quel autre joueur peut crier "Poker!" pour contester
...
export type GamePhase =
  ...
  | 'challenging'  // Fenêtre de contestation "Poker!"
...
export function gameReducer(state: GameState, action: GameAction): GameState {
  switch (action.type) {
    ...
    case 'PLAY_CARD': {
      ...
      // poser une carte (= renoncer à crier Poker) OU appuyer sur Poker.
      ...
      // Seule une contestation Poker! ou un nouveau round peut rompre la
