...
> Texas Hold'em Poker — vs bots ou en table en ligne (No Limit).

[![Build APK](https://github.com/salistar/sally-poker/actions/workflows/android-build.yml/badge.svg)](https://github.com/salistar/sally-poker/actions/workflows/android-build.yml)
[![Lint & Test](https://github.com/salistar/sally-poker/actions/workflows/lint-and-test.yml/badge.svg)](https://github.com/salistar/sally-poker/actions/workflows/lint-and-test.yml)

App mobile faisant partie de la suite **SallyCards** — Expo SDK 52, React Native 0.76, Hermes, expo-router.

| | |
|---|---|
| **Bundle ID Android** | `com.sallycards.poker` |
| **Bundle ID iOS** | `com.sallycards.poker` |
| **Couleur thème** | `#059669` |
...
- Texas Hold'em No Limit 2-9 joueurs
- Cash table + tournois Sit & Go
- Bots avec stratégies tight/loose × passive/aggressive
- Multi-joueur en ligne + voice WebRTC
- Stats détaillées : VPIP, PFR, Aggression, hand history
- Achats in-app de jetons via RevenueCat
...
```powershell
git clone https://github.com/salistar/sally-poker.git
cd sally-poker
npm install
npx expo start
...
subst Y: C:\Users\$env:USERNAME\Desktop\sally-poker
cd Y:\
...
# Install + launch
adb uninstall com.sallycards.poker 2>$null
adb install -r app\build\outputs\apk\debug\app-debug.apk
adb shell am start -n com.sallycards.poker/.MainActivity
...
keytool -genkeypair -v -storetype PKCS12 `
  -keystore poker.keystore -alias poker `
  -keyalg RSA -keysize 2048 -validity 10000

# 2) Configurer android/gradle.properties
@"
POKER_UPLOAD_STORE_FILE=poker.keystore
POKER_UPLOAD_KEY_ALIAS=poker
POKER_UPLOAD_STORE_PASSWORD=<password>
POKER_UPLOAD_KEY_PASSWORD=<password>
