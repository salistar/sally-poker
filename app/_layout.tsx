/**
 * @file _layout.tsx
 * @description Root layout for Poker. Hydrates theme + locale via
...
console.log('[Poker/_layout] module loaded');
...
export default function RootLayout() {
  console.log('[Poker/_layout] RootLayout rendering');
...
/* === End of _layout.tsx — Poker — SallyCards === */
