      ...
      <ImageBackground source={SPLASH_BG} style={{ flex: 1 }} resizeMode="cover">
        ...
        <SafeAreaView style={s.container}>
          <View style={s.langContainer}>
            ...
            <Text style={s.sallyHeader}>Sally <Text style={{ color: APP_COLOR }}>Poker</Text></Text>
      ...
      {index === 0 ? (
        <>
          ...
          <View style={s.titleRow}>
            ...
            <Text style={[s.appNameText, { color: APP_COLOR }]}>Poker</Text>
          </View>
          <Text style={s.slideDesc}>{t('slide1.desc') ?? 'Welcome to Poker — the card game that rewards bluffs.'}</Text>
        </>
      ) : (
        <>
          <>
