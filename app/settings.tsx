/**
 * @file settings.tsx
 * @description Settings modal for Poker. Language + Theme now driven by
  ...
  return (
    <View style={[s.container, { backgroundColor: palette.bg }]}>
      ...
      <ScrollView contentContainerStyle={s.scrollContent}>
        ...
        <View style={s.footer}>
          <Text style={[s.footerText, { color: palette.textSecondary }]}>SallyCards · Poker v1.0.0</Text>
