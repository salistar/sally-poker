 ...
 * @description Création d'une room Poker. Sliders pour maxPlayers (2-10),
...
export default function CreateRoomScreen() {
  ...
  const handleCreate = async () => {
    setCreating(true);
    try {
      log.bin('POST /rooms', { gameType: 'poker', maxPlayers, isPrivate });
      const room = await api.createRoomFull('poker', { maxPlayers, isPrivate });
